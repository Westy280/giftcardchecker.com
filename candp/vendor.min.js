!function(e, t) {
    ...
    C.extend({
        ...
        makeArray: function(e, t) {
            t = t || [];
            return null != e && (d(Object(e)) ? C.merge(t, "string" == typeof e ? [e] : e) : l.call(t, e)),
            t
        },
    ...
    var p = function(n) {
        ...
        var e, p, _, o, r, h, d, g, w, l, c, x, E, s, T, m, a, u, v, C = "sizzle" + +new Date, y = n.document, k = 0, b = 0, A = le(), j = le(), S = le(), D = le(), L = function(e, t) {
            return e === t && (c = !0),
            0
            ...
            for (var n = 0, i = e.length; n < i; n++)
                if (e[n] === t)
                    return n;
            return -1
        }, q = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", R = "[\\x20\\t\\r\\n\\f]", B = "(?:\\\\[\\da-fA-F]{1,6}" + R + "?|\\\\[^\\r\\n\\f]|[\\w-]|[^\0-\\x7f])+", W = "\\[" + R + "*(" + B + ")(?:" + R + "*([*^$|!~]?=)" + R + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + B + "))|)" + R + "*\\]", Q = ":(" + B + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + W + ")*)|.*)\\)|)", F = new RegExp(R + "+","g"), $ = new RegExp("^" + R + "+|((?:^|[^\\\\])(?:\\\\.)*)" + R + "+$","g"), U = new RegExp("^" + R + "*," + R + "*"), z = new RegExp("^" + R + "*([>+~]|" + R + ")" + R + "*"), X = new RegExp(R + "|>"), K = new RegExp(Q), Y = new RegExp("^" + B + "$"), V = {
            ID: new RegExp("^#(" + B + ")"),
            CLASS: new RegExp("^\\.(" + B + ")"),
            TAG: new RegExp("^(" + B + "|[*])"),
            ATTR: new RegExp("^" + W),
                ...
                if (11 !== d && (l = te.exec(e)))
                    if (r = l[1]) {
                        ...
                        if ((r = l[3]) && p.getElementsByClassName && t.getElementsByClassName)
                            return H.apply(n, t.getElementsByClassName(r)),
                            n
                    }
                if (p.qsa && !D[e + " "] && (!m || !m.test(e)) && (1 !== d || "object" !== t.nodeName.toLowerCase())) {
                    if (u = e,
                    f = t,
                    1 === d && (X.test(e) || z.test(e))) {
                        for ((f = ne.test(e) && ge(t.parentNode) || t) === t && p.scope || ((a = t.getAttribute("id")) ? a = a.replace(re, oe) : t.setAttribute("id", a = C)),
                        o = (c = h(e)).length; o--; )
                            c[o] = (a ? "#" + a : ":scope") + " " + ve(c[o]);
                        u = c.join(",")
                    }
                    try {
                        return H.apply(n, f.querySelectorAll(u)),
                        n
                    } catch (t) {
                        D(e, !0)
                    } finally {
        ...
        x = ae.setDocument = function(e) {
            ...
            T = !r(E),
            y != E && (t = E.defaultView) && t.top !== t && (t.addEventListener ? t.addEventListener("unload", i, !1) : t.attachEvent && t.attachEvent("onunload", i)),
            ...
            a = [],
            m = [],
            (p.qsa = ee.test(E.querySelectorAll)) && (ue(function(e) {
                var t;
            ...
            : function(e, t) {
                ...
                if (!r || !o)
                    return e == E ? -1 : t == E ? 1 : r ? -1 : o ? 1 : l ? I(l, e) - I(l, t) : 0;
                if (r === o)
                    return de(e, t);
        ...
        (_ = ae.selectors = {
            ...
            filter: {
                ...
                CHILD: function(h, e, t, g, m) {
                    ...
                    : function(e, t, n) {
                        var i, r, o, s, a, l, c = v != y ? "nextSibling" : "previousSibling", u = e.parentNode, f = b && e.nodeName.toLowerCase(), d = !n && !b, p = !1;
                        if (u) {
                            if (v) {
                                for (; c; ) {
                                    for (s = e; s = s[c]; )
                            ...
                            y && d) {
                                for (p = (a = (i = (r = (o = (s = u)[C] || (s[C] = {}))[s.uniqueID] || (o[s.uniqueID] = {}))[h] || [])[0] === k && i[1]) && i[2],
                                s = a && u.childNodes[a]; s = ++a && s && s[c] || (p = a = 0) || l.pop(); )
                                    if (1 === s.nodeType && ++p && s === e) {
                                        r[h] = [k, a, p];
                                        break
                                    }
                            } else if (d && (p = a = (i = (r = (o = (s = e)[C] || (s[C] = {}))[s.uniqueID] || (o[s.uniqueID] = {}))[h] || [])[0] === k && i[1]),
                            !1 === p)
                                for (; (s = ++a && s && s[c] || (p = a = 0) || l.pop()) && ((b ? s.nodeName.toLowerCase() !== f : 1 !== s.nodeType) || !++p || (d && ((r = (o = s[C] || (s[C] = {}))[s.uniqueID] || (o[s.uniqueID] = {}))[h] = [k, p]),
                                s !== e)); )
                                    ;
                            ...
                            ce(function(e, t, n, i) {
                                var r, o, s, a = [], l = [], c = t.length, u = e || function(e, t, n) {
                                    for (var i = 0, r = t.length; i < r; i++)
                                        ae(e, t[i], n);
                                    return n
                                }(h || "*", n.nodeType ? [n] : n, []), f = !p || !e && h ? u : _e(u, a, p, n, i), d = g ? v || (e ? p : c || m) ? [] : t : f;
                                if (g && g(f, d, n, i),
                                m)
                                    for (r = _e(d, l),
                                    m(r, [], n, i),
                                ...
                                if (e) {
                                    if (v || p) {
                                        ...
                                        for (o = d.length; o--; )
                                            (s = d[o]) && -1 < (r = v ? I(e, s) : a[o]) && (e[r] = !(t[r] = s))
                                    }
                                } else
                                    d = _e(d === t ? d.splice(c, d.length) : d),
                                    v ? v(null, t, d, i) : H.apply(t, d)
                            })
        ...
        d = ae.compile = function(e, t) {
            ...
            if (!s) {
                ...
                i = function(e, t, n, i, r) {
                    var o, s, a, l = 0, c = "0", u = e && [], f = [], d = w, p = e || b && _.find.TAG("*", r), h = k += null == d ? 1 : Math.random() || .1, g = p.length;
        ...
        g = ae.select = function(e, t, n, i) {
            ...
            return (c || d(e, u))(i, t, !T, n, !t || ne.test(e) && ge(t.parentNode) || t),
            n
        }
        ,
    ...
    C.fn.extend({
        ...
        is: function(e) {
            return !!S(this, "string" == typeof e && k.test(e) ? C(e) : e || [], !1).length
        }
    });
    var D, L = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/;
    (C.fn.init = function(e, t, n) {
        ...
        return (e = T.getElementById(i[2])) && (this[0] = e,
        this.length = 1),
        this
    }
    ).prototype = C.fn,
    ...
    C.each({
        ...
        C.fn[i] = function(e, t) {
            ...
            1 < this.length && (N[i] || C.uniqueSort(n),
            O.test(i) && n.reverse()),
            this.pushStack(n)
        }
    });
                        ...
                        return function() {
                            function e() {
                                ...
                                if (!(r < l)) {
                                    ...
                                    b(t) ? a ? t.call(e, c(l, o, M, a), c(l, o, I, a)) : (l++,
                                    t.call(e, c(l, o, M, a), c(l, o, I, a), c(l, o, M, o.notifyWith))) : (s !== M && (n = void 0,
                                    i = [e]),
                                    (a || o.resolveWith)(n, i))
                                }
                            }
    ...
    C.ready.then = B.then,
    "complete" === T.readyState || "loading" !== T.readyState && !T.documentElement.doScroll ? E.setTimeout(C.ready) : (T.addEventListener("DOMContentLoaded", W),
        ...
        data: function(n, e) {
            ...
            if (void 0 !== n)
                return "object" == typeof n ? this.each(function() {
                    ...
                    var t;
                    return o && void 0 === e ? void 0 !== (t = V.get(o, n)) || void 0 !== (t = Z(o, n)) ? t : void 0 : void this.each(function() {
                        V.set(this, n, e)
                    })
    ...
    C.event = {
        ...
        add: function(t, e, n, i, r) {
            var o, s, a, l, c, u, f, d, p, h = Y.get(t);
            if (X(t))
            ...
            if (m && (l = m.events)) {
                for (c = (t = (t || "").match(H) || [""]).length; c--; )
                    ...
                    p) {
                        ...
                        s && !d.length && (f.teardown && !1 !== f.teardown.call(e, h, m.handle) || C.removeEvent(e, p, m.handle),
                        delete l[p])
                    } else
                        for (p in l)
        ...
        dispatch: function(e) {
            var t, n, i, r, o, s = new Array(arguments.length), a = C.event.fix(e), l = (Y.get(this, "events") || Object.create(null))[a.type] || [], e = C.event.special[a.type] || {};
            for (s[0] = a,
            t = 1; t < arguments.length; t++)
                s[t] = arguments[t];
            if (a.delegateTarget = this,
            !e.preDispatch || !1 !== e.preDispatch.call(this, a)) {
                for (o = C.event.handlers.call(this, a, l),
                t = 0; (i = o[t++]) && !a.isPropagationStopped(); )
                    ...
                    n = 0; (r = i.handlers[n++]) && !a.isImmediatePropagationStopped(); )
                        ...
                        a.data = r.data,
                        void 0 !== (r = ((C.event.special[r.origType] || {}).handle || r.handler).apply(i.elem, s)) && !1 === (a.result = r) && (a.preventDefault(),
                        a.stopPropagation()));
        ...
        special: {
            ...
            click: {
                setup: function(e) {
                    e = this || e;
                    return ue.test(e.type) && e.click && A(e, "input") && Ce(e, "click", we),
                    !1
                },
                trigger: function(e) {
                    e = this || e;
                    return ue.test(e.type) && e.click && A(e, "input") && Ce(e, "click"),
                    !0
                },
                _default: function(e) {
                    e = e.target;
    ...
    function Ne(n, i, r, o) {
        ...
        t || o)) {
            ...
            if (a)
                ...
                u = 0; u < a; u++)
                    l = s[u],
                    de.test(l.type || "") && !Y.access(l, "globalEval") && C.contains(c, l) && (l.src && "module" !== (l.type || "").toLowerCase() ? C._evalUrl && !l.noModule && C._evalUrl(l.src, {
    ...
    function Pe(e, t, n) {
        for (var i, r = t ? C.filter(t, e) : e, o = 0; null != (i = r[o]); o++)
            ...
            i.parentNode && (n && re(i) && ge(he(i, "script")),
        ...
        clone: function(e, t, n) {
            ...
            if (t)
                if (n)
                    ...
                    Oe(e, u);
            return 0 < (s = he(u, "script")).length && ge(s, !f && he(e, "script")),
            u
        },
    ...
    var Me, Ie, qe, Re, Be, We, Qe, Fe, $e = new RegExp("^(" + ee + ")(?!px)[a-z%]+$","i"), Ue = function(e) {
    ...
    function Xe(e, t, n) {
        var i, r, o = e.style;
        return (n = n || Ue(e)) && ("" !== (r = n.getPropertyValue(t) || n[t]) || re(e) || (r = C.style(e, t)),
        !y.pixelBoxStyles() && $e.test(r) && ze.test(t) && (i = o.width,
        e = o.minWidth,
        t = o.maxWidth,
    ...
    function Ye() {
        var e;
        Fe && (Qe.style.cssText = "position:absolute;left:-11111px;width:60px;margin-top:1px;padding:0;border:0",
    ...
    C.extend({
        ...
        style: function(e, t, n, i) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                var r, o, s, a = z(t), l = nt.test(t), c = e.style;
                if (l || (t = et(a)),
    ...
    C.each(["height", "width"], function(e, a) {
        C.cssHooks[a] = {
            get: function(e, t, n) {
                if (t)
                    return !tt.test(C.css(e, "display")) || e.getClientRects().length && e.getBoundingClientRect().width ? at(e, a, n) : He(e, it, function() {
                        return at(e, a, n)
                    })
            },
            set: function(e, t, n) {
                var i, r = Ue(e), o = !y.scrollboxSize() && "absolute" === r.position, s = (o || n) && "border-box" === C.css(e, "boxSizing", !1, r), n = n ? st(e, a, n, s, r) : 0;
    ...
    function pt() {
        ut && (!1 === T.hidden && E.requestAnimationFrame ? E.requestAnimationFrame(pt) : E.setTimeout(pt, C.fx.interval),
        C.fx.tick())
    }
    function ht() {
    ...
    function vt(r, e, t) {
        var n, o, i = 0, s = vt.prefilters.length, a = C.Deferred().always(function() {
            ...
            if (o)
                return !1;
            for (var e = ct || ht(), e = Math.max(0, c.startTime + c.duration - e), t = 1 - (e / c.duration || 0), n = 0, i = c.tweens.length; n < i; n++)
                c.tweens[n].run(t);
    ...
    C.Animation = C.extend(vt, {
        ...
        prefilters: [function(e, t, n) {
            var i, r, o, s, a, l, c, u = "width"in t || "height"in t, f = this, d = {}, p = e.style, h = e.nodeType && se(e), g = Y.get(e, "fxshow");
    ...
    C.extend({
        attr: function(e, t, n) {
            ...
            if (3 !== o && 8 !== o && 2 !== o)
                return void 0 === e.getAttribute ? C.prop(e, t, n) : (1 === o && C.isXMLDoc(e) || (r = C.attrHooks[t.toLowerCase()] || (C.expr.match.bool.test(t) ? yt : void 0)),
        ...
        toggleClass: function(r, t) {
            ...
            return "boolean" == typeof t && s ? t ? this.addClass(r) : this.removeClass(r) : b(r) ? this.each(function(e) {
                ...
                if (s)
                    ...
                    void 0 !== r && "boolean" != o || ((e = Et(this)) && Y.set(this, "__className__", e),
    ...
    C.extend(C.event, {
        trigger: function(e, t, n, i) {
            var r, o, s, a, l, c, u, f = [n || T], d = v.call(e, "type") ? e.type : e, p = v.call(e, "namespace") ? e.namespace.split(".") : [], h = u = o = n = n || T;
            if (3 !== n.nodeType && 8 !== n.nodeType && !At.test(d + C.event.triggered) && (-1 < d.indexOf(".") && (d = (p = d.split(".")).shift(),
            p.sort()),
            a = d.indexOf(":") < 0 && "on" + d,
            ...
            i || !c.trigger || !1 !== c.trigger.apply(n, t))) {
                if (!i && !c.noBubble && !g(n)) {
                    ...
                    At.test(s + d) || (h = h.parentNode); h; h = h.parentNode)
                        f.push(h),
                        o = h;
                ...
                return e.type = d,
                i || e.isDefaultPrevented() || c._default && !1 !== c._default.apply(f.pop(), t) || !X(n) || a && b(n[d]) && !g(n) && ((o = n[a]) && (n[a] = null),
                C.event.triggered = d,
    ...
    C.fn.extend({
        ...
        serializeArray: function() {
            return this.map(function() {
                ...
                var e = this.type;
                return this.name && !C(this).is(":disabled") && Pt.test(this.nodeName) && !Nt.test(e) && (this.checked || !ue.test(e))
            }).map(function(e, t) {
                var n = C(this).val();
    ...
    C.extend({
        ...
        ajax: function(e, t) {
            ...
            e = void 0),
            t = t || {};
            var l, c, u, n, f, i, d, p, r, o, h = C.ajaxSetup({}, t), g = h.context || h, m = h.context && (g.nodeType || g.jquery) ? C(g) : C.event, v = C.Deferred(), y = C.Callbacks("once memory"), b = h.statusCode || {}, s = {}, a = {}, _ = "canceled", w = {
                readyState: 0,
            ...
            if (v.promise(w),
            h.url = ((e || h.url || jt.href) + "").replace(Bt, jt.protocol + "//"),
            ...
            d)
                return w;
            for (r in (p = C.event && h.global) && 0 == C.active++ && C.event.trigger("ajaxStart"),
            h.type = h.type.toUpperCase(),
            h.hasContent = !Rt.test(h.type),
            c = h.url.replace(Mt, ""),
            h.hasContent ? h.data && h.processData && 0 === (h.contentType || "").indexOf("application/x-www-form-urlencoded") && (h.data = h.data.replace(Ht, "+")) : (o = h.url.slice(c.length),
            h.data && (h.processData || "string" == typeof h.data) && (c += (Dt.test(c) ? "&" : "?") + h.data,
            delete h.data),
            !1 === h.cache && (c = c.replace(It, "$1"),
            o = (Dt.test(c) ? "&" : "?") + "_=" + St.guid++ + o),
            h.url = c + o),
            h.ifModified && (C.lastModified[c] && w.setRequestHeader("If-Modified-Since", C.lastModified[c]),
            ...
            function x(e, t, n, i) {
                ...
                !i && -1 < C.inArray("script", h.dataTypes) && (h.converters["text script"] = function() {}
                ),
                s = function(e, t, n, i) {
                ...
                i ? (h.ifModified && ((n = w.getResponseHeader("Last-Modified")) && (C.lastModified[c] = n),
    ...
    C.parseHTML = function(e, t, n) {
        ...
        i = !n && [],
        (n = j.exec(e)) ? [t.createElement(n[1])] : (n = ve([e], t, i),
...
function(t) {
    ...
    var o, s, c, u = {}, f = a.fn.init, d = a.find, p = /\[(\s*[-\w]+\s*)([~|^$*]?=)\s*([-\w#]*?#[-\w#]*)\s*\]/, h = /\[(\s*[-\w]+\s*)([~|^$*]?=)\s*([-\w#]*?#[-\w#]*)\s*\]/g, g = /^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g;
    ...
    var _, w = !(a.fn.toggleClass = function(t) {
        return void 0 !== t && "boolean" != typeof t ? v.apply(this, arguments) : (l("jQuery.fn.toggleClass( boolean ) is deprecated"),
        this.each(function() {
    ...
    ), x = /^[a-z]/, E = /^(?:Border(?:Top|Right|Bottom|Left)?(?:Width|)|(?:Margin|Padding)?(?:Top|Right|Bottom|Left)?|(?:Min|Max)?(?:Width|Height))$/;
    ...
    a.swap = function(e, t, n, i) {
        var r, o = {};
        for (r in w || l("jQuery.swap() is undocumented and deprecated"),
        t)
            o[r] = e.style[r],
            e.style[r] = t[r];
    ...
    a.fn.css = function(e, t) {
        ...
        this) : ("number" == typeof t && (t = n = b(e),
        x.test(t) && E.test(t[0].toUpperCase() + t.slice(1)) || a.cssNumber[n] || l('Number-typed values are deprecated for jQuery.fn.css( "' + e + '", value )')),
        _.apply(this, arguments))
    }
    ;
    var T, C, k, A, j = a.data;
    a.data = function(e, t, n) {
        var i, r, o;
        if (t && "object" == typeof t && 2 === arguments.length) {
            for (o in i = a.hasData(e) && j.call(this, e),
            r = {},
            t)
                o !== b(o) ? (l("jQuery.data() always sets/gets camelCased names: " + o),
                i[o] = t[o]) : r[o] = t[o];
            return j.call(this, e, r),
            t
        }
        return t && "string" == typeof t && t !== b(t) && (i = a.hasData(e) && j.call(this, e)) && t in i ? (l("jQuery.data() always sets/gets camelCased names: " + t),
        2 < arguments.length && (i[t] = n),
        i[t]) : j.apply(this, arguments)
    }
    ,
    a.fx && (k = a.Tween.prototype.run,
    A = function(e) {
        return e
    }
    ,
    ...
    a.event.fix = function(e) {
        var t = e.type
          ...
          , i = a.event.props;
        if (i.length)
            for (l("jQuery.event.props are deprecated and removed: " + i.join()); i.length; )
    ...
    a.each(["load", "unload", "error"], function(e, t) {
        a.fn[t] = function() {
            ...
            return "load" === t && "string" == typeof e[0] ? S.apply(this, e) : (l("jQuery.fn." + t + "() is deprecated"),
            e.splice(0, 0, t),
    ...
    a.fn.offset = function() {
        var e = this[0];
        return !e || e.nodeType && e.getBoundingClientRect ? I.apply(this, arguments) : (l("jQuery.fn.offset() requires a valid DOM element"),
...
function(e, t) {
    ...
    function t(e) {
        ...
        return t && "#" !== t || (t = (e = e.getAttribute("href")) && "#" !== e ? e.trim() : null),
        t
    }
    function f(e) {
    ...
    function m(r, o, s) {
        Object.keys(s).forEach(function(e) {
            var t, n = s[e], i = o[e], t = i && h(i) ? "element" : null == (t = i) ? "" + t : {}.toString.call(t).match(/\s([a-z]+)/i)[1].toLowerCase();
            if (!new RegExp(n).test(t))
                throw new Error(r.toUpperCase() + ': Option "' + e + '" provided type "' + t + '" but expected type "' + n + '".')
        })
    }
    function s(e) {
        if (!e)
    ...
    var _, w, x = "transitionend", n = "rtl" === document.documentElement.dir, E = (_ = {},
    {
        set: function(e, t, n) {
        ...
        delete: function(e, t) {
            var n;
            void 0 === e.bsKey || (n = e.bsKey).key === t && (delete _[n.id],
            delete e.bsKey)
        }
    }), T = function(e, t, n) {
        E.set(e, t, n)
    ...
    function q(e, t, n, i, r) {
        ...
        "string" == typeof t && e && (n || (n = i,
        i = null),
        o = (l = I(t, n, i))[0],
        s = l[1],
        a = l[2],
        (c = M(l = (c = H(e))[a] || (c[a] = {}), s, o ? n : null)) ? c.oneOff = c.oneOff && r : (t = P(s, t.replace(A, "")),
        (i = o ? (d = e,
        p = n,
        h = i,
        function e(t) {
    ...
    var B = {
            ...
            if ("string" == typeof a && s) {
                ...
                n && Object.keys(l).forEach(function(e) {
                    ...
                    Object.keys(o).forEach(function(e) {
                        e.includes(r) && R(t, n, i, (e = o[e]).originalHandler, e.delegationSelector)
                    })
                });
                var c = l[r] || {};
                Object.keys(c).forEach(function(e) {
                    var t = e.replace(S, "");
                    o && !a.includes(t) || R(s, l, r, (e = c[e]).originalHandler, e.delegationSelector)
                })
            }
        },
        trigger: function(e, t, n) {
            if ("string" != typeof t || !e)
                return null;
            var i, r = b(), o = t.replace(j, ""), s = t !== o, a = N.has(o), l = !0, c = !0, u = !1, f = null;
            return s && r && (i = r.Event(t, n),
            r(e).trigger(i),
            l = !i.isPropagationStopped(),
            c = !i.isImmediatePropagationStopped(),
            u = i.isDefaultPrevented()),
            a ? (f = document.createEvent("HTMLEvents")).initEvent(o, l, !0) : f = new CustomEvent(t,{
                bubbles: l,
                cancelable: !0
            }),
      ...
      , $ = function(e) {
        ...
        t._removeElement = function(e) {
            ...
            e.classList.contains("fade") ? (t = p(e),
            B.one(e, x, function() {
    ...
    B.on(document, "click.bs.alert.data-api", '[data-bs-dismiss="alert"]', $.handleDismiss(new $)),
    e(function() {
        var e, t = b();
        t && (e = t.fn[Q],
    ...
    var G = {
      ...
      , ue = function(n) {
        function o(e, t) {
            ...
            e._indicatorsElement = J.findOne(".carousel-indicators", e._element),
            e._touchSupported = "ontouchstart"in document.documentElement || 0 < navigator.maxTouchPoints,
        ...
        e.pause = function(e) {
            e || (this._isPaused = !0),
            J.findOne(".carousel-item-next, .carousel-item-prev", this._element) && (r(this._element),
            this.cycle(!0)),
        ...
        e._addTouchEventListeners = function() {
            function e(e) {
                n._pointerEvent && ce[e.pointerType.toUpperCase()] ? n.touchStartX = e.clientX : n._pointerEvent || (n.touchStartX = e.touches[0].clientX)
            }
            function t(e) {
                n._pointerEvent && ce[e.pointerType.toUpperCase()] && (n.touchDeltaX = e.clientX - n.touchStartX),
                n._handleSwipe(),
            ...
            this._pointerEvent ? (B.on(this._element, "pointerdown.bs.carousel", e),
            B.on(this._element, "pointerup.bs.carousel", t),
            this._element.classList.add("pointer-event")) : (B.on(this._element, "touchstart.bs.carousel", e),
        ...
        e._getItemIndex = function(e) {
            return this._items = e && e.parentNode ? J.find(".carousel-item", e.parentNode) : [],
        ...
        e._setActiveIndicatorElement = function(e) {
            if (this._indicatorsElement) {
                for (var t = J.find(".active", this._indicatorsElement), n = 0; n < t.length; n++)
        ...
        e._updateInterval = function() {
            ...
            e && ((e = Number.parseInt(e.getAttribute("data-bs-interval"), 10)) ? (this._config.defaultInterval = this._config.defaultInterval || this._config.interval,
            this._config.interval = e) : this._config.interval = this._config.defaultInterval || this._config.interval)
        }
        ,
        e._slide = function(e, t) {
            var n, i, r = this, o = J.findOne(le, this._element), s = this._getItemIndex(o), a = t || o && this._getItemByDirection(e, o), l = this._getItemIndex(a), t = Boolean(this._interval), c = e === re ? (n = "carousel-item-start",
            i = "carousel-item-next",
            "left") : (n = "carousel-item-end",
            i = "carousel-item-prev",
            "right");
            a && a.classList.contains(ae) ? this._isSliding = !1 : this._triggerSlideEvent(a, c).defaultPrevented || o && a && (this._isSliding = !0,
            t && this.pause(),
            this._setActiveIndicatorElement(a),
            this._activeElement = a,
            this._element.classList.contains("slide") ? (a.classList.add(i),
            y(a),
            o.classList.add(n),
            a.classList.add(n),
            e = p(o),
        ...
        o.dataApiClickHandler = function(e) {
            var t, n, i = d(this);
            i && i.classList.contains("carousel") && (t = l({}, G.getDataAttributes(i), G.getDataAttributes(this)),
    ...
    B.on(document, "click.bs.carousel.data-api", "[data-bs-slide], [data-bs-slide-to]", ue.dataApiClickHandler),
    B.on(window, "load.bs.carousel.data-api", function() {
        for (var e = J.find('[data-bs-ride="carousel"]'), t = 0, n = e.length; t < n; t++)
    ...
    var fe = "collapse"
      ...
      , _e = function(c) {
        function s(t, e) {
            ...
            n._triggerArray = J.find(be + '[href="#' + t.id + '"],' + be + '[data-bs-target="#' + t.id + '"]');
            for (var i = J.find(be), r = 0, o = i.length; r < o; r++) {
                ...
                null !== a && l.length && (n._selector = a,
                n._triggerArray.push(s))
            }
        ...
        e.show = function() {
            var t = this;
            if (!this._isTransitioning && !this._element.classList.contains(ge)) {
                this._parent && 0 === (n = J.find(".show, .collapsing", this._parent).filter(function(e) {
                    return "string" == typeof t._config.parent ? e.getAttribute("data-bs-parent") === t._config.parent : e.classList.contains(me)
                })).length && (n = null);
                var e, n, i = J.findOne(this._selector);
                if (n) {
                    var r, o = n.find(function(e) {
                        return i !== e
                    });
                    if ((r = o ? C(o, de) : null) && r._isTransitioning)
                        return
                }
                B.trigger(this._element, "show.bs.collapse").defaultPrevented || (n && n.forEach(function(e) {
        ...
        e.hide = function() {
            var e = this;
            if (!this._isTransitioning && this._element.classList.contains(ge) && !B.trigger(this._element, "hide.bs.collapse").defaultPrevented) {
                ...
                if (0 < n)
                    for (var i = 0; i < n; i++) {
                        var r = this._triggerArray[i]
                          , o = d(r);
                        o && !o.classList.contains(ge) && (r.classList.add(ye),
        ...
        ,
        e._getConfig = function(e) {
            return (e = l({}, pe, e)).toggle = Boolean(e.toggle),
            m(fe, e, he),
            e
        }
        ,
        ...
        e._getParent = function() {
            ...
            h(e) ? void 0 === e.jquery && void 0 === e[0] || (e = e[0]) : e = J.findOne(e);
            var t = be + '[data-bs-parent="' + e + '"]';
            return J.find(t, e).forEach(function(e) {
                var t = d(e);
        ...
        e._addAriaAndCollapsedClass = function(e, t) {
            var n;
            e && t.length && (n = e.classList.contains(ge),
        ...
        s.collapseInterface = function(e, t) {
            var n = C(e, de)
              , i = l({}, pe, G.getDataAttributes(e), "object" == typeof t && t ? t : {});
    ...
    B.on(document, "click.bs.collapse.data-api", be, function(e) {
        ...
        J.find(e).forEach(function(e) {
            var t = C(e, de)
              , t = t ? (null === t._parent && "string" == typeof n.parent && (t._config.parent = n.parent,
        ...
        fn: function(e) {
            ...
            Object.keys(r.elements).forEach(function(e) {
                var t = r.styles[e] || {}
                  , n = r.attributes[e] || {}
                  , i = r.elements[e];
                Ue(i) && Qe(i) && (Object.assign(i.style, t),
        ...
        effect: function(e) {
            ...
            function() {
                Object.keys(i.elements).forEach(function(e) {
                    ...
                    Ue(t) && Qe(t) && (Object.assign(t.style, e),
                    Object.keys(n).forEach(function(e) {
                        t.removeAttribute(e)
                    }))
                })
    ...
    function Ye(e, t) {
        ...
        if (e.contains(t))
            return !0;
        if (n && ((n = n)instanceof Fe(n).ShadowRoot || n instanceof ShadowRoot)) {
            var i = t;
            do {
                if (i && e.isSameNode(i))
                    return !0
    ...
    function Je(e) {
        return "html" === Qe(e) ? e : e.assignedSlot || e.parentNode || e.host || Ge(e)
    }
    function Ze(e) {
        if (!Ue(e) || "fixed" === Ve(e).position)
            return null;
        var t = e.offsetParent;
        if (t) {
            e = Ge(t);
            if ("body" === Qe(t) && "static" === Ve(t).position && "static" !== Ve(e).position)
                return e
        }
        return t
    }
    function et(e) {
        for (var t = Fe(e), n = Ze(e); n && 0 <= ["table", "td", "th"].indexOf(Qe(n)) && "static" === Ve(n).position; )
            n = Ze(n);
        return (!n || "body" !== Qe(n) || "static" !== Ve(n).position) && (n || function(e) {
            for (var t = Je(e); Ue(t) && ["html", "body"].indexOf(Qe(t)) < 0; ) {
                var n = Ve(t);
    ...
    var st = {
        ...
        phase: "main",
        fn: function(e) {
            var t, n, i, r = e.state, o = e.name, s = r.elements.arrow, a = r.modifiersData.popperOffsets, l = Xe(r.placement), c = tt(l), u = 0 <= [Te, Ee].indexOf(l) ? "height" : "width";
            s && a && (t = r.modifiersData[o + "#persistent"].padding,
            n = Ke(s),
            i = "y" === c ? we : Te,
            e = "y" === c ? xe : Ee,
            l = r.rects.reference[u] + r.rects.reference[c] - a[c] - r.rects.popper[u],
            a = a[c] - r.rects.reference[c],
            s = (s = et(s)) ? "y" === c ? s.clientHeight || 0 : s.clientWidth || 0 : 0,
            a = l / 2 - a / 2,
            i = t[i],
            e = s - n[u] - t[e],
            e = nt(i, a = s / 2 - n[u] / 2 + a, e),
            r.modifiersData[o] = ((o = {})[c] = e,
            o.centerOffset = e - a,
            o))
        },
        effect: function(e) {
            ...
            null != e && ("string" != typeof e || (e = t.elements.popper.querySelector(e))) && Ye(t.elements.popper, e) && (t.elements.arrow = e,
    ...
    function lt(e) {
        ...
        {
            x: Math.round(f * p) / p || 0,
            y: Math.round(d * p) / p || 0
        })
          , c = l.x
          , u = l.y
          ...
          , p = we
          , l = window;
        a && ((r = et(t)) === Fe(t) && (r = Ge(t)),
        i === we && (p = xe,
        u -= r.clientHeight - n.height,
        u *= s ? 1 : -1),
        i === Te && (d = Ee,
        c -= r.clientWidth - n.width,
        c *= s ? 1 : -1));
        var a = Object.assign({
            position: o
        }, a && at);
        return s ? Object.assign(Object.assign({}, a), {}, ((s = {})[p] = f ? "0" : "",
        s[d] = e ? "0" : "",
        s.transform = (l.devicePixelRatio || 1) < 2 ? "translate(" + c + "px, " + u + "px)" : "translate3d(" + c + "px, " + u + "px, 0)",
        s)) : Object.assign(Object.assign({}, a), {}, ((a = {})[p] = f ? u + "px" : "",
        a[d] = e ? c + "px" : "",
        a.transform = "",
        a))
    }
    var ct = {
        ...
        fn: function(e) {
            ...
            null != t.modifiersData.popperOffsets && (t.styles.popper = Object.assign(Object.assign({}, t.styles.popper), lt(Object.assign(Object.assign({}, e), {}, {
                offsets: t.modifiersData.popperOffsets,
                position: t.options.strategy,
                adaptive: n
            })))),
            null != t.modifiersData.arrow && (t.styles.arrow = Object.assign(Object.assign({}, t.styles.arrow), lt(Object.assign(Object.assign({}, e), {}, {
    ...
    function _t(e, t) {
        void 0 === t && (t = []);
        var n = function e(t) {
            return 0 <= ["html", "body", "#document"].indexOf(Qe(t)) ? t.ownerDocument.body : Ue(t) && bt(t) ? t : e(Je(t))
        }(e)
          , i = "body" === Qe(n)
          , e = Fe(n)
    ...
    function xt(e, t) {
        ...
        s = a.offsetTop)),
        {
            ...
            x: o + yt(r),
            y: s
        })) : Ue(t) ? ((i = mt(n = t)).top = i.top + n.clientTop,
        ...
        i = Math.max(s.scrollWidth, s.clientWidth, n ? n.scrollWidth : 0, n ? n.clientWidth : 0),
        e = Math.max(s.scrollHeight, s.clientHeight, n ? n.scrollHeight : 0, n ? n.clientHeight : 0),
        r = -t.scrollLeft + yt(r),
        t = -t.scrollTop,
        "rtl" === Ve(n || s).direction && (r += Math.max(s.clientWidth, n ? n.clientWidth : 0) - i),
        {
            width: i,
            height: e,
            x: r,
    ...
    function Et(n, e, t) {
        var i, r, o, e = "clippingParents" === e ? (r = _t(Je(i = n)),
        $e(o = 0 <= ["absolute", "fixed"].indexOf(Ve(i).position) && Ue(i) ? et(i) : i) ? r.filter(function(e) {
            return $e(e) && Ye(e, o) && "body" !== Qe(e)
        }) : []) : [].concat(e), e = [].concat(e, [t]), t = e[0], t = e.reduce(function(e, t) {
            t = xt(n, t);
            return e.top = Math.max(t.top, e.top),
    ...
    function Ct(e) {
        var t, n = e.reference, i = e.element, r = e.placement, e = r ? Xe(r) : null, r = r ? Tt(r) : null, o = n.x + n.width / 2 - i.width / 2, s = n.y + n.height / 2 - i.height / 2;
        switch (e) {
        case we:
            t = {
                x: o,
    ...
    var At = {
        ...
        fn: function(e) {
            ...
            if (!n.modifiersData[i]._skip) {
                for (var r = t.mainAxis, o = void 0 === r || r, e = t.altAxis, s = void 0 === e || e, r = t.fallbackPlacements, a = t.padding, l = t.boundary, c = t.rootBoundary, u = t.altBoundary, e = t.flipVariations, f = void 0 === e || e, d = t.allowedAutoPlacements, e = n.options.placement, t = Xe(e), t = r || (t === e || !f ? [pt(e)] : function(e) {
                    if (Xe(e) === Ce)
                        return [];
                    var t = pt(e);
                    return [gt(e), t, gt(t)]
                }(e)), p = [e].concat(t).reduce(function(e, t) {
                    return e.concat(Xe(t) === Ce ? function(n, e) {
                        void 0 === e && (e = {});
                        var t = e.placement
                          , i = e.boundary
                          , r = e.rootBoundary
                ...
                if (v)
                    for (var k = f ? 3 : 1; 0 < k; k--)
                        if ("break" === function(t) {
                            ...
                            break;
                n.placement !== y && (n.modifiersData[i]._skip = !0,
                n.placement = y,
                n.reset = !0)
            }
        },
        ...
        fn: function(e) {
            var s = e.state
              ...
              , e = Pe.reduce(function(e, t) {
                ...
                r = (r = (n = "function" == typeof r ? r(Object.assign(Object.assign({}, i), {}, {
                    placement: n
                })) : r)[0]) || 0,
                n = ((n = n[1]) || 0) * t,
                0 <= [Te, Ee].indexOf(o) ? {
    ...
    var Nt = {
        ...
        phase: "main",
        fn: function(e) {
            var t, n = e.state, i = e.options, r = e.name, o = void 0 === (_ = i.mainAxis) || _, s = void 0 !== (w = i.altAxis) && w, a = i.boundary, l = i.rootBoundary, c = i.altBoundary, u = i.padding, f = void 0 === (x = i.tether) || x, d = i.tetherOffset, p = void 0 === d ? 0 : d, h = kt(n, {
                boundary: a,
                rootBoundary: l,
                padding: u,
                altBoundary: c
            }), g = Xe(n.placement), m = Tt(n.placement), v = !m, y = tt(g), b = "x" === y ? "y" : "x", e = n.modifiersData.popperOffsets, _ = n.rects.reference, w = n.rects.popper, x = "function" == typeof p ? p(Object.assign(Object.assign({}, n.rects), {}, {
            ...
            d = (m = n.modifiersData["arrow#persistent"] ? n.modifiersData["arrow#persistent"].padding : it())[d],
            a = m[a],
            w = nt(0, _[l], w[l]),
            d = v ? _[l] / 2 - g - w - d - x : p - w - d - x,
            w = v ? -_[l] / 2 + g + w + a + x : o + w + a + x,
            x = (a = n.elements.arrow && et(n.elements.arrow)) ? "y" === y ? a.clientTop || 0 : a.clientLeft || 0 : 0,
            a = n.modifiersData.offset ? n.modifiersData.offset[n.placement][y] : 0,
            x = e[y] + d - a - x,
            a = e[y] + w - a,
    ...
    function Pt(e, t, n) {
        ...
        return !o && (o || n) || ("body" === Qe(t) && !bt(i) || (s = (o = t) !== Fe(o) && Ue(o) ? {
            scrollLeft: (n = o).scrollLeft,
            scrollTop: n.scrollTop
        } : vt(o)),
        Ue(t) ? ((e = mt(t)).x += t.clientLeft,
        e.y += t.clientTop) : i && (e.x = yt(i))),
        {
        ...
        return function(i, r, t) {
            ...
            var n, o, s = {
                ...
                setOptions: function(e) {
                    u(),
                    s.options = Object.assign(Object.assign(Object.assign({}, d), s.options), e),
                    s.scrollParents = {
                        reference: $e(i) ? _t(i) : i.contextElement ? _t(i.contextElement) : [],
                        popper: _t(r)
                    };
                    var n, t, e = (e = [].concat(f, s.options.modifiers),
            ...
            return It(i, r) && c.setOptions(t).then(function(e) {
    ...
    var Rt = qt()
      , Bt = qt({
        defaultModifiers: [ft, Ot, ct, ze]
    })
      , Wt = qt({
        defaultModifiers: [ft, Ot, ct, ze, Lt, At, Nt, st, Dt]
    })
      , Qt = Object.freeze({
        __proto__: null,
        popperGenerator: qt,
      ...
      , fn = function(n) {
        ...
        return e.toggle = function() {
            var e;
            this._element.disabled || this._element.classList.contains(Jt) || (e = this._element.classList.contains(Zt),
            c.clearMenus(),
            e || this.show())
        }
        ,
        e.show = function() {
            if (!(this._element.disabled || this._element.classList.contains(Jt) || this._menu.classList.contains(Zt))) {
                ...
                if (!B.trigger(this._element, "show.bs.dropdown", t).defaultPrevented) {
                    if (!this._inNavbar) {
                        ...
                        var n = this._element;
                        "parent" === this._config.reference ? n = e : h(this._config.reference) && (n = this._config.reference,
        ...
        e.hide = function() {
            var e, t;
            this._element.disabled || this._element.classList.contains(Jt) || !this._menu.classList.contains(Zt) || (e = c.getParentFromElement(this._element),
            t = {
                relatedTarget: this._element
            },
            B.trigger(e, Vt, t).defaultPrevented || (this._popper && this._popper.destroy(),
            this._menu.classList.toggle(Zt),
            this._element.classList.toggle(Zt),
            B.trigger(e, Gt, t)))
        }
        ...
        ,
        e._getConfig = function(e) {
            return e = l({}, this.constructor.Default, G.getDataAttributes(this._element), e),
        ...
        c.clearMenus = function(e) {
            if (!e || 2 !== e.button && ("keyup" !== e.type || "Tab" === e.key))
                for (var t = J.find(en), n = 0, i = t.length; n < i; n++) {
                    var r, o, s = c.getParentFromElement(t[n]), a = C(t[n], $t), l = {
                        relatedTarget: t[n]
                    };
                    e && "click" === e.type && (l.clickEvent = e),
                    a && (r = a._menu,
                    t[n].classList.contains(Zt) && (e && ("click" === e.type && /input|textarea/i.test(e.target.tagName) || "keyup" === e.type && "Tab" === e.key) && r.contains(e.target) || B.trigger(s, Vt, l).defaultPrevented || ("ontouchstart"in document.documentElement && (o = []).concat.apply(o, document.body.children).forEach(function(e) {
        ...
        c.dataApiKeydownHandler = function(e) {
            if ((/input|textarea/i.test(e.target.tagName) ? !("Space" === e.key || e.key !== zt && (e.key !== Kt && e.key !== Xt || e.target.closest(tn))) : Yt.test(e.key)) && (e.preventDefault(),
            e.stopPropagation(),
            !this.disabled && !this.classList.contains(Jt))) {
                var t = c.getParentFromElement(this)
                  , n = this.classList.contains(Zt);
                if (e.key === zt)
                    return (this.matches(en) ? this : J.prev(this, en)[0]).focus(),
                    void c.clearMenus();
                n && "Space" !== e.key ? (n = J.find(".dropdown-menu .dropdown-item:not(.disabled):not(:disabled)", t).filter(s)).length && (t = n.indexOf(e.target),
                e.key === Xt && 0 < t && t--,
                e.key === Kt && t < n.length - 1 && t++,
                n[t = -1 === t ? 0 : t].focus()) : c.clearMenus()
            }
        }
        ,
        a(c, null, [{
    ...
    var dn = "modal"
      ...
      , Dn = function(i) {
        function r(e, t) {
            ...
            return n._config = n._getConfig(t),
        ...
        e.show = function(e) {
            var t, n = this;
            this._isShown || this._isTransitioning || (this._element.classList.contains(Cn) && (this._isTransitioning = !0),
            t = B.trigger(this._element, yn, {
                relatedTarget: e
            }),
            ...
            B.on(this._element, wn, '[data-bs-dismiss="modal"]', function(e) {
                return n.hide(e)
            }),
        ...
        e.hide = function(e) {
            ...
            (e = this._element.classList.contains(Cn)) && (this._isTransitioning = !0),
            this._setEscapeEvent(),
            this._setResizeEvent(),
            B.off(document, bn),
        ...
        e._setEscapeEvent = function() {
            var t = this;
            this._isShown ? B.on(this._element, xn, function(e) {
        ...
        e._setResizeEvent = function() {
            var e = this;
            this._isShown ? B.on(window, _n, function() {
        ...
        e._showBackdrop = function(e) {
            var t, n = this, i = this._element.classList.contains(Cn) ? Cn : "";
            ...
            i ? (t = p(this._backdrop),
            B.one(this._backdrop, x, e),
            g(this._backdrop, t)) : e()) : !this._isShown && this._backdrop ? (this._backdrop.classList.remove(kn),
            i = function() {
                n._removeBackdrop(),
                e()
            }
            ,
            this._element.classList.contains(Cn) ? (t = p(this._backdrop),
            B.one(this._backdrop, x, i),
            g(this._backdrop, t)) : i()) : e()
        }
        ,
        e._triggerBackdropTransition = function() {
            var e, t, n = this;
            B.trigger(this._element, "hidePrevented.bs.modal").defaultPrevented || ((e = this._element.scrollHeight > document.documentElement.clientHeight) || (this._element.style.overflowY = "hidden"),
            this._element.classList.add(An),
            t = p(this._dialog),
            B.off(this._element, x),
            B.one(this._element, x, function() {
                n._element.classList.remove(An),
                e || (B.one(n._element, x, function() {
        ...
        e._adjustDialog = function() {
            ...
            (!this._isBodyOverflowing && e && !n || this._isBodyOverflowing && !e && n) && (this._element.style.paddingLeft = this._scrollbarWidth + "px"),
            (this._isBodyOverflowing && !e && !n || !this._isBodyOverflowing && e && n) && (this._element.style.paddingRight = this._scrollbarWidth + "px")
        }
        ,
        ...
        e._setScrollbar = function() {
            var e, t, i = this;
            this._isBodyOverflowing && (J.find(jn).forEach(function(e) {
                var t = e.style.paddingRight
                  , n = window.getComputedStyle(e)["padding-right"];
                G.setDataAttribute(e, "padding-right", t),
                e.style.paddingRight = Number.parseFloat(n) + i._scrollbarWidth + "px"
            }),
            J.find(Sn).forEach(function(e) {
                ...
                e.style.marginRight = Number.parseFloat(n) - i._scrollbarWidth + "px"
            }),
            e = document.body.style.paddingRight,
            t = window.getComputedStyle(document.body)["padding-right"],
            G.setDataAttribute(document.body, "padding-right", e),
            document.body.style.paddingRight = Number.parseFloat(t) + this._scrollbarWidth + "px"),
        ...
        e._resetScrollbar = function() {
            J.find(jn).forEach(function(e) {
                ...
                void 0 !== t && (G.removeDataAttribute(e, "padding-right"),
                e.style.paddingRight = t)
            }),
            J.find(Sn).forEach(function(e) {
                var t = G.getDataAttribute(e, "margin-right");
                void 0 !== t && (G.removeDataAttribute(e, "margin-right"),
                e.style.marginRight = t)
            });
            var e = G.getDataAttribute(document.body, "padding-right");
            void 0 === e ? document.body.style.paddingRight = "" : (G.removeDataAttribute(document.body, "padding-right"),
        ...
        r.jQueryInterface = function(n, i) {
            return this.each(function() {
                var e = C(this, pn)
                  , t = l({}, gn, G.getDataAttributes(this), "object" == typeof n && n ? n : {})
                  , e = e || new r(this,t);
                if ("string" == typeof n) {
                    if (void 0 === e[n])
    ...
    B.on(document, "click.bs.modal.data-api", '[data-bs-toggle="modal"]', function(e) {
        ...
        B.one(n, yn, function(e) {
            e.defaultPrevented || B.one(n, vn, function() {
                s(t) && t.focus()
            })
        });
        var i = C(n, pn);
        i || (e = l({}, G.getDataAttributes(n), G.getDataAttributes(this)),
        i = new Dn(n,e)),
        i.show(this)
    }),
    e(function() {
    ...
    var Ln = new Set(["background", "cite", "href", "itemtype", "longdesc", "poster", "src", "xlink:href"])
    ...
    function Pn(e, r, t) {
        ...
        if (t && "function" == typeof t)
            return t(e);
        for (var t = (new window.DOMParser).parseFromString(e, "text/html"), o = Object.keys(r), s = (e = []).concat.apply(e, t.body.querySelectorAll("*")), n = function(e) {
            var t = s[e]
            ...
            e.forEach(function(e) {
                !function(e, t) {
                    ...
                    if (t.includes(n))
                        return !Ln.has(n) || Boolean(e.nodeValue.match(On) || e.nodeValue.match(Nn));
    ...
    var Hn = "tooltip"
      ...
      , Vn = function(n) {
        function i(e, t) {
            ...
            return (e = n.call(this, e) || this)._isEnabled = !0,
            e._timeout = 0,
            e._hoverState = "",
            e._activeTrigger = {},
            e._popper = null,
        ...
        e.toggle = function(e) {
            ...
            (n = C(e.delegateTarget, t)) || (n = new this.constructor(e.delegateTarget,this._getDelegateConfig()),
            T(e.delegateTarget, t, n)),
            n._activeTrigger.click = !n._activeTrigger.click,
            n._isWithActiveTrigger() ? n._enter(null, n) : n._leave(null, n)) : this.getTipElement().classList.contains(zn) ? this._leave(null, this) : this._enter(null, this))
        }
        ,
        e.dispose = function() {
        ...
        e.show = function() {
            ...
            this.isWithContent() && this._isEnabled && (n = B.trigger(this._element, this.constructor.Event.SHOW),
            e = (null === (t = c(this._element)) ? this._element.ownerDocument.documentElement : t).contains(this._element),
            !n.defaultPrevented && e && (t = this.getTipElement(),
            n = o(this.constructor.NAME),
            t.setAttribute("id", n),
            this._element.setAttribute("aria-describedby", n),
            this.setContent(),
            this.config.animation && t.classList.add(Un),
            e = "function" == typeof this.config.placement ? this.config.placement.call(this, t, this._element) : this.config.placement,
            n = this._getAttachment(e),
            this._addAttachmentClass(n),
            e = this._getContainer(),
            T(t, this.constructor.DATA_KEY, this),
            this._element.ownerDocument.documentElement.contains(this.tip) || e.appendChild(t),
            B.trigger(this._element, this.constructor.Event.INSERTED),
            this._popper = Wt(this._element, t, this._getPopperConfig(n)),
            t.classList.add(zn),
            (n = "function" == typeof this.config.customClass ? this.config.customClass() : this.config.customClass) && (t = t.classList).add.apply(t, n.split(" ")),
            "ontouchstart"in document.documentElement && (i = []).concat.apply(i, document.body.children).forEach(function(e) {
                B.on(e, "mouseover", v())
            }),
            n = function() {
                var e = r._hoverState;
            ...
            ,
            this.tip.classList.contains(Un) ? (i = p(this.tip),
            B.one(this.tip, x, n),
            g(this.tip, i)) : n()))
        }
        ,
        e.hide = function() {
            var e, t, n, i = this;
            this._popper && (e = this.getTipElement(),
            t = function() {
                i._hoverState !== Xn && e.parentNode && e.parentNode.removeChild(e),
                i._cleanTipClass(),
            ...
            ,
            B.trigger(this._element, this.constructor.Event.HIDE).defaultPrevented || (e.classList.remove(zn),
            ...
            this.tip.classList.contains(Un) ? (n = p(e),
            B.one(e, x, t),
            g(e, n)) : t(),
            this._hoverState = ""))
        }
        ...
        e.setContent = function() {
            ...
            this.setElementContent(J.findOne(".tooltip-inner", e), this.getTitle()),
            e.classList.remove(Un, zn)
        }
        ,
        e.setElementContent = function(e, t) {
            if (null !== e)
                return "object" == typeof t && h(t) ? (t.jquery && (t = t[0]),
                void (this.config.html ? t.parentNode !== e && (e.innerHTML = "",
                e.appendChild(t)) : e.textContent = t.textContent)) : void (this.config.html ? (this.config.sanitize && (t = Pn(t, this.config.allowList, this.config.sanitizeFn)),
        ...
        e._getContainer = function() {
            return !1 === this.config.container ? document.body : h(this.config.container) ? this.config.container : J.findOne(this.config.container)
        }
        ,
        ...
        e._setListeners = function() {
            ...
            this.config.trigger.split(" ").forEach(function(e) {
                var t;
                "click" === e ? B.on(n._element, n.constructor.Event.CLICK, n.config.selector, function(e) {
                    return n.toggle(e)
                }) : "manual" !== e && (t = e === Kn ? n.constructor.Event.MOUSEENTER : n.constructor.Event.FOCUSIN,
                e = e === Kn ? n.constructor.Event.MOUSELEAVE : n.constructor.Event.FOCUSOUT,
        ...
        e._enter = function(e, t) {
            ...
            (t = t || C(e.delegateTarget, n)) || (t = new this.constructor(e.delegateTarget,this._getDelegateConfig()),
            T(e.delegateTarget, n, t)),
            e && (t._activeTrigger["focusin" === e.type ? Yn : Kn] = !0),
            t.getTipElement().classList.contains(zn) || t._hoverState === Xn ? t._hoverState = Xn : (clearTimeout(t._timeout),
            t._hoverState = Xn,
        ...
        e._getConfig = function(e) {
            ...
            e.sanitize && (e.template = Pn(e.template, e.allowList, e.sanitizeFn)),
            e
        }
        ,
    ...
    var si = "scrollspy"
      ...
      , mi = function(i) {
        function n(e, t) {
            var n = i.call(this, e) || this;
            return n._scrollElement = "BODY" === e.tagName ? window : e,
            n._config = n._getConfig(t),
            n._selector = n._config.target + " " + pi + ", " + n._config.target + " " + hi + ", " + n._config.target + " ." + fi,
            n._offsets = [],
            n._targets = [],
        ...
        return e.refresh = function() {
            var t = this
              , e = this._scrollElement === this._scrollElement.window ? "offset" : gi
              , i = "auto" === this._config.method ? e : this._config.method
              , r = i === gi ? this._getScrollTop() : 0;
            this._offsets = [],
            this._targets = [],
            this._scrollHeight = this._getScrollHeight(),
            J.find(this._selector).map(function(e) {
                var t = f(e)
                  , n = t ? J.findOne(t) : null;
                if (n) {
                    e = n.getBoundingClientRect();
                    if (e.width || e.height)
                        return [G[i](n).top + r, t]
                }
                return null
            }).filter(function(e) {
                return e
        ...
        e._getConfig = function(e) {
            var t;
            return "string" != typeof (e = l({}, ci, "object" == typeof e && e ? e : {})).target && h(e.target) && ((t = e.target.id) || (t = o(si),
            e.target.id = t),
            e.target = "#" + t),
            m(si, e, ui),
            e
        ...
        e._activate = function(t) {
            ...
            var e = this._selector.split(",").map(function(e) {
              ...
              , e = J.findOne(e.join(","));
            e.classList.contains(fi) ? (J.findOne(".dropdown-toggle", e.closest(".dropdown")).classList.add(di),
            e.classList.add(di)) : (e.classList.add(di),
        ...
        ,
        e._clear = function() {
            J.find(this._selector).filter(function(e) {
        ...
        n.jQueryInterface = function(t) {
            return this.each(function() {
                var e = (e = C(this, ai)) || new n(this,"object" == typeof t && t);
                if ("string" == typeof t) {
                    if (void 0 === e[t])
                        throw new TypeError('No method named "' + t + '"');
                    e[t]()
    ...
    var vi = "bs.tab"
      ...
      , wi = function(e) {
        ...
        return t.show = function() {
            var e, t, n, i, r = this;
            this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && this._element.classList.contains(yi) || this._element.classList.contains("disabled") || (e = d(this._element),
            (i = this._element.closest(".nav, .list-group")) && (n = "UL" === i.nodeName || "OL" === i.nodeName ? _i : bi,
            t = (t = J.find(n, i))[t.length - 1]),
            n = null,
            t && (n = B.trigger(t, "hide.bs.tab", {
                relatedTarget: this._element
            })),
            ...
            i = function() {
                ...
                B.trigger(r._element, "shown.bs.tab", {
                    relatedTarget: t
                })
            }
            ,
        ...
        t._activate = function(e, t, n) {
            var i = this
              , r = (!t || "UL" !== t.nodeName && "OL" !== t.nodeName ? J.children(t, bi) : J.find(_i, t))[0]
        ...
        t._transitionComplete = function(e, t, n) {
            ...
            (i = J.findOne(":scope > .dropdown-menu .active", t.parentNode)) && i.classList.remove(yi),
            "tab" === t.getAttribute("role") && t.setAttribute("aria-selected", !1)),
            e.classList.add(yi),
            "tab" === e.getAttribute("role") && e.setAttribute("aria-selected", !0),
            y(e),
            e.classList.contains("fade") && e.classList.add("show"),
            e.parentNode && e.parentNode.classList.contains("dropdown-menu") && (e.closest(".dropdown") && J.find(".dropdown-toggle").forEach(function(e) {
    ...
    var xi = "toast"
      ...
      , Si = function(n) {
        function i(e, t) {
            e = n.call(this, e) || this;
            return e._config = e._getConfig(t),
            e._timeout = null,
            e._setListeners(),
            e
        }
        ...
        return e.show = function() {
            ...
            this._config.animation ? (t = p(this._element),
        ...
        e.hide = function() {
            var e, t, n = this;
            this._element.classList.contains(Ci) && (B.trigger(this._element, "hide.bs.toast").defaultPrevented || (e = function() {
        ...
        ,
        e._getConfig = function(e) {
            return e = l({}, ji, G.getDataAttributes(this._element), "object" == typeof e && e ? e : {}),
        ...
        i.jQueryInterface = function(t) {
            return this.each(function() {
                var e = (e = C(this, Ei)) || new i(this,"object" == typeof t && t);
                if ("string" == typeof t) {
                    if (void 0 === e[t])
                        throw new TypeError('No method named "' + t + '"');
                    e[t](this)
